...
export default function ContactInfo() {
  ...
  const contactMethods = [
    {
      ...
      title: 'Email Us',
      content: 'info@hackabyte.org',
      action: 'mailto:info@hackabyte.org',
  ...
  const socialLinks = [
    {
      ...
      url: 'https://discord.gg/drXX4sZmbX'
    },
    {
      name: 'Twitter',
      icon: (
      ...
      url: 'https://twitter.com/hackabyte'
    },
    {
      name: 'Instagram',
      icon: (
      ...
      url: 'https://instagram.com/hackabyte'
    },
    {
      name: 'LinkedIn',
      icon: (
      ...
      url: 'https://linkedin.com/company/hackabyte'
    },
    {
      name: 'GitHub',
      icon: (
      ...
      url: 'https://github.com/hackabyte'
    }
  ];
  ...
  return (
    <motion.div
      ...
      className="bg-[#1E1E24] p-6 md:p-10 rounded-lg shadow-xl h-full"
    >
      ...
      <div className="mb-8">
        <ul className="space-y-6">
          {contactMethods.map((method, i) => (
            ...
            >
              <div className="bg-[#FF2247]/10 p-3 rounded-full mr-4">
                <div className="text-[#FF2247]">{method.icon}</div>
              </div>
              <div>
                ...
                {method.action ? (
                  <a 
                    href={method.action} 
                    className="text-gray-300 hover:text-[#FF2247] transition-colors"
                  >
                    {method.content}
                  </a>
                ) : (
        ...
        <div className="flex flex-wrap gap-4">
          {socialLinks.map((social, i) => (
            <motion.a
              ...
              className="bg-[#26262C] hover:bg-[#FF2247]/20 text-gray-300 hover:text-[#FF2247] p-3 rounded-full transition-colors"
      ...
      <motion.div
        ...
        className="mt-10 p-4 border border-gray-700 rounded-md bg-[#26262C]/50"
      >
