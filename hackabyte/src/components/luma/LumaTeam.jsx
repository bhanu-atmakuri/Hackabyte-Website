...
export default function LumaTeam() {
  ...
  return (
    <section className="py-20 bg-[#16161A]" id="team" ref={ref}>
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-xl text-white max-w-3xl mx-auto">
            Meet the dedicated team behind LUMA, working to make coding education accessible to all.
          </p>
        </motion.div>
        ...
        >
          <a 
            href="https://discord.gg/luma" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center px-6 py-3 bg-[#5865F2] rounded-lg text-white font-semibold hover:bg-[#4752C4] transition-colors"
          >
