      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-xl text-white max-w-3xl mx-auto">
            Meet our dedicated team of educators and volunteers who make LUMA's mission possible.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="bg-[#1A1A1E] rounded-xl overflow-hidden border border-gray-800 hover:border-[#BADA55]/30 transition-all duration-300"
            >
              ...
              <div className="p-6">
                ...
                <p className="text-[#BADA55] font-medium mb-3">{member.role}</p>
                
                <div className="flex mt-4 space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#BADA55] transition-colors">
